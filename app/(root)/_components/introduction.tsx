...
function Introduction() {
    return (
        <section className="flex flex-col justify-center items-center gap-12 bg-gray-50 py-10 px-2 dark:bg-gray-800">
            <span className="font-heading text-primary text-3xl dark:text-white">چرا نواندیش؟</span>
